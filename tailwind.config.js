      ...
      typography: (theme) => ({
        DEFAULT: {
          css: {
            ...
            '--tw-prose-links': theme('colors.elk-blue[600]'),
        ...
        elk: {
          css: {
            ...
            '--tw-prose-headings': theme('colors.elk-blue[800]'),
            '--tw-prose-links': theme('colors.elk-orange[600]'),
            '--tw-prose-bold': theme('colors.elk-blue[700]'),
          },
        },
      }),
      backgroundImage: {
